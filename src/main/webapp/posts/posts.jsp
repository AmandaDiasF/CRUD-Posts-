					...
					<tbody>
						...
						<c:forEach var="post" items="${posts}">
							<tr>
								...
								<td>
									<a class="bi bi-pencil-square" href="${pageContext.request.contextPath}/posts/update?postId=${post.getId()}"></a>
									
									<a class="bi bi-trash" href="${pageContext.request.contextPath}/posts/delete?postId=${post.getId()}"></a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
